...
public class Main {
    public static void main(String[] args) {
        ...
        HangHoaManager manager = new HangHoaManager();
        ...
        while (continueAdding) {
            ...
            if (loaiHang == 1) {
                ...
                hangHoa = new HangThucPham(maHang, tenHang, soLuongTon, donGia, LocalDate.parse(ngaySanXuatStr), LocalDate.parse(ngayHetHanStr), nhaCungCap);
